...
//            imageEdgeInsets = UIEdgeInsetsMake(0, 0, 0, labelWidth + space/2.0);
            labelEdgeInsets = UIEdgeInsetsMake(0, -imageWith-space/2.0, 0, imageWith+space/2.0);
//            labelEdgeInsets = UIEdgeInsetsMake(0, -imageWith-space/2.0, 0, 0);
...
- (void)layoutButtonWithEdgeInsetsStyle1:(MKButtonEdgeInsetsStyle)style
                        imageTitleSpace:(CGFloat)space {
    /**
    ...
    /**
     *  button的imageView和titleLabel 并没有占满整个btn，换句话说，labelWidth+imageWidth < buttonWidth
     *  因为imageView左边相对于button，所以设置edgeInsets时，left要加上imageOriginx，imageview才能居中
     *  其他情况同理
     *
     */
    switch (style) {
        case MKButtonEdgeInsetsStyleTop:
        {
            imageEdgeInsets = UIEdgeInsetsMake(-0.5*labelHeight, 0.5*labelWidth+imageOriginx, 0.5*(labelHeight+space),0.5*labelWidth);
