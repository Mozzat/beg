...
- (void)setDataDic:(NSDictionary *)dataDic{
    ...
    _dataDic = dataDic;
    [self.headImgeV loadImageViewWithImageString:dataDic[@"cAuthorImage"] WithPlaceHoldeImage:@"美女头像"];
    self.nameLab.text = dataDic[@"cAuthorName"];
    self.commentLab.text = dataDic[@"cBody"];
    self.countLab.text = [NSString stringWithFormat:@"%@",dataDic[@"nLikeNum"]];
